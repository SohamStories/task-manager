...
// .wrangler/tmp/bundle-6FwrSQ/checked-fetch.js
...
var require_edge = __commonJS({
  "node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    var qe = (e, t, r) => (r = e != null ? ca(ma(e)) : {}, ri(t || !e || !e.__esModule ? ur(r, "default", { value: e, enumerable: true }) : r, e));
    var ga = (e) => ri(ur({}, "__esModule", { value: true }), e);
    var y;
    var c = Se(() => {
      "use strict";
      y = { nextTick: (e, ...t) => {
    ...
    var xi = Le((Ye) => {
      ...
      d();
      m();
      var ai = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), ha = ai((e) => {
        "use strict";
    ...
    var ul = (e, t) => ({ adapterName: t.adapterName, provider: t.provider, options: t.options, queryRaw: fe(e, t.queryRaw.bind(t)), executeRaw: fe(e, t.executeRaw.bind(t)), commit: fe(e, t.commit.bind(t)), rollback: fe(e, t.rollback.bind(t)) });
    function fe(e, t) {
      return async (...r) => {
        try {
          return await t(...r);
...
Prisma Accelerate has built-in connection pooling to prevent such errors: https://pris.ly/client/error-accelerate`), r;
    ...
    var Mn = (e, t) => Fo(t).reduce((r, n) => r && r[n], e);
    var _o = (e, t, r) => Fo(t).reduceRight((n, i, o, s) => Object.assign({}, Mn(e, s.slice(0, o)), { [i]: n }), r);
    function hu(e, t) {
...
`);
    ...
    var Yn = ({ clientMethod: e, activeProvider: t }) => (r) => {
      let n = "", i;
      if (r instanceof Ft)
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\Asus\\Desktop\\TASK MANAGER\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\Asus\\Desktop\\TASK MANAGER\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
      ...
      "inlineSchemaHash": "0470db6e3743b745fb6648515246cacd3282c502bd38ba99afb732c8bb426d19",
      "copyEngine": false
    };
    config.dirname = "/";
    config.runtimeDataModel = JSON.parse('{"models":{"User":{"dbName":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"Int","default":{"name":"autoincrement","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","isGenerated":false,"isUpdatedAt":false},{"name":"username","kind":"scalar","isList":false,"isRequired":true,"isUnique":true,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","isGenerated":false,"isUpdatedAt":false},{"name":"password","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","isGenerated":false,"isUpdatedAt":false},{"name":"task","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Task","relationName":"TaskToUser","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Task":{"dbName":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"Int","default":{"name":"autoincrement","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"authorId","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"Int","isGenerated":false,"isUpdatedAt":false},{"name":"title","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","isGenerated":false,"isUpdatedAt":false},{"name":"description","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","isGenerated":false,"isUpdatedAt":false},{"name":"Completed","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"Boolean","default":false,"isGenerated":false,"isUpdatedAt":false},{"name":"author","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","relationName":"TaskToUser","relationFromFields":["authorId"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{},"types":{}}');
...
// node_modules/@soham6745/taskmanager/dist/index.js
var require_dist = __commonJS({
  "node_modules/@soham6745/taskmanager/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-6FwrSQ/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-6FwrSQ/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/routes/user.ts
var import_taskmanager = __toESM(require_dist());
var userRouter = new Hono2();
userRouter.post("/signup", async (c) => {
  const body = await c.req.json();
  const { success } = import_taskmanager.signupInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
...
userRouter.post("/signin", async (c) => {
  const body = await c.req.json();
  const { success } = import_taskmanager.signinInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
      message: "Inputs are not correct"
...
var import_taskmanager2 = __toESM(require_dist());
var taskRouter = new Hono2();
taskRouter.use("/*", async (c, next) => {
  const autheader = c.req.header("authorization") || "";
  try {
    const user = await verify2(autheader, c.env.JWT_SECRET);
    if (user) {
...
taskRouter.post("/", async (c) => {
  const body = await c.req.json();
  const { success } = import_taskmanager2.createtaskInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
      message: "Inputs are not correct"
...
taskRouter.put("/", async (c) => {
  const body = await c.req.json();
  const { success } = import_taskmanager2.updatetaskInput.safeParse(body);
  if (!success) {
    c.status(411);
    return c.json({
      message: "Inputs are not correct"
